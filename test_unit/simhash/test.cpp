...
{
    Simhasher simhasher("./simhash/cppjieba/dict/jieba.dict.utf8", "./simhash/cppjieba/dict/hmm_model.utf8", "./simhash/cppjieba/dict/idf.utf8", "./simhash/cppjieba/dict/stop_words.utf8");
